...
export default {
  ...
  apis: {
    hmppsAuth: {
      ...
      agent: new AgentConfig(Number(get('HMPPS_AUTH_TIMEOUT_DEADLINE', 10000))),
    ...
    prisonerSearch: {
      ...
      agent: new AgentConfig(Number(get('PRISONER_SEARCH_TIMEOUT_DEADLINE', 15000))),
    },
    restrictedPatientApi: {
      ...
      agent: new AgentConfig(Number(get('RESTRICTED_PATIENT_API_TIMEOUT_DEADLINE', 30000))),
    },
    tokenVerification: {
